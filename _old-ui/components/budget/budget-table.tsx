...
import { Table, TableBody, TableCell, TableFooter, TableHead, TableHeader, TableRow } from '@/_old-ui/components/ui/table';
import { Button } from '@/_old-ui/components/ui/button';
import * as React from 'react';
import { DialogTrigger } from '@/_old-ui/components/ui/dialog';
import { BudgetFormDialog } from '@/_old-ui/components/budget/budget-form-dialog';
import { Account, AccountType, Budget, Category, OperationType, Period } from '@prisma/client';
import { CategoryImage } from '@/_old-ui/components/categories/category-image';
