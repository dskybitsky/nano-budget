...
import { MainNav } from '@/_old-ui/components/main-nav';
import { Account } from '@prisma/client';
import { AccountSwitcher } from '@/_old-ui/components/accounts/account-switcher';
import { Balance } from '@/_old-ui/components/balance';
