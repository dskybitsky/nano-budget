import { Button, buttonVariants } from '@/_old-ui/components/ui/button';
import type { CalendarProps } from '@/_old-ui/components/ui/calendar';
        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-2 top-4',
                ),
                button_next: cn(
                    buttonVariants({ variant: 'outline' }),
                    'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-2 top-4',
                ),
                ...
                MonthCaption: ({ calendarMonth }) => {
                    return (
                        <div className="inline-flex gap-2">
                            ...
                            >
                                <SelectTrigger className="w-fit border-none shadow-none gap-1 focus:bg-accent focus:text-accent-foreground">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {MONTHS.map((month) => (
                            ...
                            >
                                <SelectTrigger className="w-fit gap-1 border-none shadow-none focus:bg-accent focus:text-accent-foreground">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {YEARS.map((year) => (
