import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/_old-ui/components/ui/card';
import { CategoriesList } from '@/_old-ui/components/categories/categories-list';
import { Button } from '@/_old-ui/components/ui/button';
import { CirclePlus, Trash } from 'lucide-react';
import * as React from 'react';
import { cookies } from 'next/headers';
import { DialogTrigger } from '@/_old-ui/components/ui/dialog';
import { viewAccount } from '@/actions/use-cases/view-account';
import { CategoryFormDialog } from '@/_old-ui/components/categories/category-form-dialog';
import { Page } from '@/_old-ui/components/page';
import { AlertDialogTrigger } from '@/_old-ui/components/ui/alert-dialog';
import { AccountDeleteDialog } from '@/_old-ui/components/accounts/account-delete-dialog';
import { PeriodsTable } from '@/_old-ui/components/period/periods-table';
import { PeriodFormDialog } from '@/_old-ui/components/period/period-form-dialog';
import { getServerSession } from 'next-auth';
import { redirect } from 'next/navigation';
import { authOptions } from '@/lib/authOptions';
import { AccountCard } from '@/_old-ui/components/accounts/account-card';
